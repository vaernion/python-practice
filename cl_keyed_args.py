...
parser = argparse.ArgumentParser(
    description="Print song a certain number of times with optional formatting",
...
print(
    "This is a song:"
    if args.verbose == 1
    else "A song is a musical composition intended to be vocally performed by the human voice."
    if args.verbose == 2
    else "Song:"
)
